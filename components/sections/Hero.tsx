  ...
  return (
    <section id="hero" className="relative overflow-hidden pt-28 pb-20 lg:pt-36 lg:pb-32">
      ...
      <div className="container-wide relative z-10 flex flex-col items-center text-center">
        ...
        {/* Main Typography */}
        <h1 className="max-w-5xl text-5xl sm:text-6xl lg:text-[5rem] font-black leading-[1.05] tracking-tight text-foreground mb-8">
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-muted-foreground leading-relaxed mb-10 font-medium">
          {t.hero.subheadline}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto mb-14">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full sm:w-auto border-border text-foreground hover:bg-secondary hover:border-border font-bold gap-2.5 text-base h-14 px-8 rounded-xl transition-all duration-300 backdrop-blur-md bg-background/50"
          >
        ...
        <div className="relative w-full max-w-6xl mx-auto rounded-3xl overflow-hidden border border-border shadow-[0_0_80px_rgba(0,0,0,0.15)] dark:shadow-[0_0_80px_rgba(0,0,0,0.8)] mt-20">
          ...
          <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 z-20 bg-card/90 backdrop-blur-xl border border-border rounded-2xl p-5 shadow-2xl max-w-xs sm:max-w-sm text-left">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <p className="text-sm sm:text-base font-bold text-card-foreground">Raka Pratama, S.H., LL.M.</p>
                  <TooltipProvider>
                    <Tooltip>
